...
// Landing page component for the Book Finder application
const LandingPage = () => {
  // Hook for navigation
  const navigate = useNavigate();

  // Handles user click on the "Get Started" button
  const handleClick = () => {
    // Navigates to the "find-book" route
    navigate('/find-book');
  };
    ...
    >
      ...
      <div className="bg-gray-300 opacity-85 p-8 rounded-lg shadow-md">
        <div className="text-center max-w-2xl">
          ...
          <h1 className="text-4xl text-black md:text-6xl mb-4">Hi John!</h1>
          <h2 className="text-4xl text-black md:text-6xl mb-4">Welcome to Book Finder</h2>
          <p className="text-black text-lg md:text-2xl pt-6 mb-6">
            Your journey starts here! Discover amazing books and experiences.
          </p>
          {/* Button to navigate to book search page */}
          <button
            onClick={handleClick}
